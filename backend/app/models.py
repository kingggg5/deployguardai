...
class ChangeRecord(Base):
    ...
    rollback_ready: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    observability_score: Mapped[float | None] = mapped_column(Float, nullable=True)
    previous_failures: Mapped[int | None] = mapped_column(Integer, nullable=True)
